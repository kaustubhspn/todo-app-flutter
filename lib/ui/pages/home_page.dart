...
class TodoActionPage extends StatefulWidget {
  ...
  @override
  State<TodoActionPage> createState() => _TodoActionPageState();
}

class _TodoActionPageState extends State<TodoActionPage> {
          ...
          children: [
            ...
            task.isCompleted == 1
                ...
                : _buildBottomSheet(
                    ...
                    onTap: () {
                      NotifyHelper.cancelNotificationWithID(task.id!);
